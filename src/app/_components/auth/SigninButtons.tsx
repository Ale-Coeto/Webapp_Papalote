...
export const GoogleButton = ({
  ...
  return (
    <button
      className={twMerge("flex h-14 items-center space-x-2 rounded-lg bg-white px-14 py-3 font-semibold text-gray-800 shadow-md", className)}
      onClick={() => signIn(googleLink ?? "")}
    >
      <img src="/google_logo.png" alt="Google Logo" className="h-8" />
      <span className="text-xl">Entrar con Google</span>
    </button>
  );
};
