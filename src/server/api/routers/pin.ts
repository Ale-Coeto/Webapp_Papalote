...
export const pinRouter = createTRPCRouter({
  ...
  createPin: protectedModificationProcedure
    .input(
      z.object({
        name: z.string(),
        color: z.string(),
  ...
  updatePins: protectedModificationProcedure
    .input(
      z.array(
        z.object({
          id: z.number(),
  ...
  updatePin: protectedModificationProcedure
    .input(
      z.object({
        id: z.number(),
        name: z.string(),
  ...
  deletePin: protectedModificationProcedure
    .input(z.number())
    .mutation(async ({ ctx, input }) => {
